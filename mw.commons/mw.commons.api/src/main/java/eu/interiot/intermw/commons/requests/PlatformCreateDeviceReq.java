...
public class PlatformCreateDeviceReq {

    private String platformId;
    private List<IoTDevice> devices;
    private String clientId;

    public PlatformCreateDeviceReq(String platformId, List<IoTDevice> devices, String clientId) {
        this.platformId = platformId;
        this.devices = devices;
        this.clientId = clientId;
    }

    public PlatformCreateDeviceReq(Message message) throws InvalidMessageException {
    ...
    public Message toMessage(String conversationId) {
        ...
        metadata.setMessageType(URIManagerMessageMetadata.MessageTypesEnum.PLATFORM_CREATE_DEVICE);
